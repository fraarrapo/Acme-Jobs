...
<acme:form readonly="true">
	...
	<acme:form-textarea code="authenticated.challenge.form.label.rewardsgold" path="rewardGold"/>
	<acme:form-textarea code="authenticated.challenge.form.label.rewardssilver" path="rewardSilver"/>
	<acme:form-textarea code="authenticated.challenge.form.label.rewardsbronze" path="rewardBronze"/>
